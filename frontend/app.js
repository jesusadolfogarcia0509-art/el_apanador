document.addEventListener('DOMContentLoaded', () => {
    ...
    // BOTÓN LENS (Llamada segura al Backend)
    ...
    cameraInput.addEventListener('change', async (e) => {
        ...
        try {
            ...
            // PETICIÓN A TU PROPIO SERVIDOR (Vercel)
            // Ya no usamos la clave aquí, la tiene Vercel guardada
    ...
    // RESTO DE FUNCIONES (Categorías, Favoritos, Render...)
