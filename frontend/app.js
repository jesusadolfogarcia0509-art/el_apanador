    ...
    function generateRollerHTML(id, title, variants, type) {
        ...
        variants.forEach((v, idx) => {
            ...
            if(type === 'tool') {
                ...
                buttons = `
                    <div class="roller-actions">
                        <a href="${v.url}" target="_blank" class="action-btn ${btnClass}" style="padding:8px; font-size:0.8rem; width:100%; display:flex; justify-content:center; align-items:center; gap:5px;">${icon} Ver Video</a>
                    </div>
                `;
            }
